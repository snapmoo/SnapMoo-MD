package com.bangkit.snapmoo.ui.home.mouth
...
import com.bangkit.snapmoo.databinding.ActivityMouthBinding
import com.bangkit.snapmoo.ui.adapter.ImageSlideAdapter

class MouthActivity : AppCompatActivity(), View.OnClickListener {
    private lateinit var binding: ActivityMouthBinding
    private lateinit var adapter: ImageSlideAdapter
    private val list = ArrayList<ImageData>()
    private lateinit var dots: ArrayList<TextView>
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMouthBinding.inflate(layoutInflater)
