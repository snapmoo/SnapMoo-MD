package com.bangkit.snapmoo.ui.home.foot
...
import com.bangkit.snapmoo.databinding.ActivityFootBinding
import com.bangkit.snapmoo.ui.adapter.ImageSlideAdapter

class FootActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun selectedDot(position : Int){
        for (i in 0 until list.size){
            if (i == position)
                dots[i].setTextColor(ContextCompat.getColor(this, R.color.blue_500))
            else
                dots[i].setTextColor(ContextCompat.getColor(this, R.color.silver_400))
        }
    }
